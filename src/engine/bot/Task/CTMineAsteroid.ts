...
export class CTMineAsteroid<T extends {isMoving: number; isInRange: number; hasTargetMoved: number; hasAsteroidToMine: number; isMining: number;}> extends CompoundTask<T> {
