...
export class ShipDomain<T extends {isMoving: number; isInRange: number; hasEnnemyToAttack: number; hasAsteroidToMine: number; hasShipToProtect: number; isMining: number, isReadyToFire: number}> extends Domain<T> {
