...
export class SRenderMissile implements ISystem {
  public id = 'RenderMissile';
  ...
  onUpdate(ecs: ECSManager): void {
    const entities = ecs.selectEntitiesFromComponents([CMissile.id, CPosition.id, CRenderer.id]);
